            ...
            <div class="row wow fadeInUp" data-wow-duration="1s">
                <div class="col-md-9 col-lg-7 col-xl-6 col-xxl-5 m-auto">
                    <div class="fp__login_area">
                        ...
                        <p>Input your email to send a verification link</p>
                        <form method="POST" action="{{ route('password.email') }}">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="fp__login_imput"><label class="form-label">email</label><input type="email" name="email" value="{{ old('email') }}" placeholder="Email"></div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="fp__login_imput"><button type="submit" class="common_btn">verify mail</button></div>
                                </div>
                            </div>
                        </form>
