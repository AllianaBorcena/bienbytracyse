    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $delete = "<a href='".route('admin.admin-management.destroy', $query->id)."' class='btn btn-danger
                delete-item ml-2'><i class='fas fa-trash'></i></a>";
    ...
    public function getColumns(): array
{
    ...
    if (auth()->user()->id === 1) {
        ...
        // Return columns for the admin only/employee
        return [
            Column::make('id'),
            Column::make('name'),
            Column::make('email'),
