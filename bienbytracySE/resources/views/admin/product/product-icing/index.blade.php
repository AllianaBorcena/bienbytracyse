    ...
    <section class="section">
        ...
        <div class = "row">
            <div class="col-md-6">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.product-icing.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <tbody>
                                @foreach ($icings as $icing)
                                    <tr>
                                        ...
                                        <td>{{ $icing->price }}</td>
                                        <td>
                                            <a href='{{ route('admin.product-icing.destroy', $icing->id) }}'
                                                class='btn
                                        btn-danger delete-item mx-2'><i
