                        ...
                        <div class="accordion-body collapse show" id="panel-body-1" data-parent="#accordion" style="">
                            <form action="{{ route('admin.why-choose-title.update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="why_choose_top_title">Top Title</label>
                                    <input type="text" class="form-control" id="why_choose_top_title" name="why_choose_top_title"
                                        value="{{ @$titles['why_choose_top_title'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="why_choose_main_title">Main Title</label>
                                    <input type="text" class="form-control" id="why_choose_main_title" name="why_choose_main_title"
                                        value="{{ @$titles['why_choose_main_title'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="why_choose_sub_title">Sub Title</label>
                                    <input type="text" class="form-control" id="why_choose_sub_title" name="why_choose_sub_title"
